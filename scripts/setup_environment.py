...
def check_cuda():
    ...
    try:
        ...
        if torch.cuda.is_available():
            ...
            print("⚠️  CUDA niedostępne - będzie używany CPU")
    except ImportError:
        print("⚠️  PyTorch nie zainstalowany")
...
def check_lm_studio_connection():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print("⚠️  LM Studio nie odpowiada na porcie 1234")
    except Exception as e:
        print(f"⚠️  Nie można połączyć się z LM Studio: {e}")
